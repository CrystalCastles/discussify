  ...
  return (
    <>
      ...
      <main className="bg-mainBlack min-h-screen">
        {session ? (
          <div className="grid lg:grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-10 xs:mx-5 overflow-hidden pt-[5rem] pb-5">
            <div className="">
          ...
          <div className="flex h-screen items-center justify-center">
            ...
            <div className="text-center">
              <h1 className="text-white xs:text-[3rem] md:text-[5rem]">Discussify</h1>
              <p className="text-white xs:text-md md:text-lg">Discuss anything on Spotify.</p>
              <button
